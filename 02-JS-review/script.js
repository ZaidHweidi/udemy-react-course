...
const summary = `${title}, a ${pages}-page long book, was written by ${author} and published on ${getYear(publicationDate)}. It falls under the genres of ${primaryGenre} and ${secondaryGenre}.`;
summary;
